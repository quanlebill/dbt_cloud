...
stage as (
    select
        concat(src1.country_name, '-', src1.type, '-', src1.order_year) as gdp_pii,
        src1.country_name as country_name,
        src1.type as type,
        TO_TIMESTAMP(CONCAT(src1.order_year,'-01-01'),  'YYYY-MM-DD') as order_year,
